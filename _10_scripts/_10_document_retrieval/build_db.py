...
if __name__ == '__main__':
    ...
    path_wiki_database_dir = os.path.join(
        config.ROOT, config.DATA_DIR, config.DATABASE_DIR)

    wiki_database = WikiDatabaseSqlite(path_wiki_database_dir, path_wiki_pages)

    # wiki_database = create_wiki_database(path_wiki_database, path_wiki_pages)
